...
| `backend/src/main/resources/db/migration/` | Flyway migrations V1–V99. Next is V100. (…V96 waterproof cordage/smoke hood, V97 armour, V98 poisoned weapons, V99 tea/grain ingredients.) |
...
## What Is Built (Migrations V1–V99, all applied)
...
> Everything is on `development` (pushed) as `devosphere.tech` (never `johncalado`). **Migrations through V99.**
> Full suite **162 backend tests + 28 SQL regressions green** on the V1–V99 chain; each commit compiles with tests
