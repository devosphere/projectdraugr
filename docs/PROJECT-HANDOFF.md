...
| `backend/src/main/resources/db/migration/` | Flyway migrations V1–V111. Next is V112. (…V108 hammerstones, V109 bare-hand carrying, V110 bare-hand wraps, V111 bare-hand cordage materials.) |
...
## What Is Built (Migrations V1–V111, all applied)
...
> Everything is on `development` (pushed) as `devosphere.tech` (never `johncalado`). **Migrations through V111.**
> Full suite **162 backend tests + 35 SQL regressions green** on the V1–V111 chain; each commit compiles with tests
