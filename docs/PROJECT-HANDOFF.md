...
| `backend/src/main/resources/db/migration/` | Flyway migrations V1–V75. Next is V76. (V71 nets, V72 container access-state, V73 gathering vocab, V74 crafting vocab, V75 container progression.) |
...
## What Is Built (Migrations V1–V75, all applied)
...
> Full suite **158 backend tests + 11 SQL regressions green** on the V1–V75 chain; each commit compiles with tests
...
> - **EPIC #54 supply chains — IN PROGRESS.** **#56 containers ADVANCED (V75):** fixed a latent bug —
