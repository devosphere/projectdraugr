...
| `backend/src/main/resources/db/migration/` | Flyway migrations V1–V88. Next is V89. (…V85 knappable stone, V86 nut foods, V87 herbal poultices, V88 wild food plants.) |
...
## What Is Built (Migrations V1–V88, all applied)
...
> Everything is on `development` (pushed) as `devosphere.tech` (never `johncalado`). **Migrations through V88.**
> Full suite **162 backend tests + 17 SQL regressions green** on the V1–V88 chain; each commit compiles with tests
