...
| `backend/src/main/resources/db/migration/` | Flyway migrations V1–V124. Next is V125. (…V109 bare-hand carrying, V110 bare-hand wraps, V111 bare-hand cordage, V112 arrival viability, V113 bare-hand carrying completion, V114 bare-hand food handling, V115 bare-hand clay ornaments, V116 bare-hand raw materials, V117 handwork mass-conservation, V118 smoke face wrap + smoke-exposure vector, V119 first-aid supplies, V120 bare-hand resin scavenge, V121 resin torch, V122 stone-boiling, V123 early shields, V124 early clubs.) |
...
## What Is Built (Migrations V1–V124, all applied)
...
> Full suite **162 backend tests + 50 SQL regressions green** on the V1–V124 chain; each commit compiles with tests
...
>   usable as weapons; dr0125/dr0126). Remaining on the
