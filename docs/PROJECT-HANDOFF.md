...
| `backend/src/main/resources/db/migration/` | Flyway migrations V1–V85. Next is V86. (…V82 building stock, V83 first-era shelters, V84 plant-fibre materials, V85 knappable stone.) |
...
## What Is Built (Migrations V1–V85, all applied)
...
> Everything is on `development` (pushed) as `devosphere.tech` (never `johncalado`). **Migrations through V85.**
> Full suite **162 backend tests + 14 SQL regressions green** on the V1–V85 chain; each commit compiles with tests
