...
| `backend/src/main/resources/db/migration/` | Flyway migrations V1–V76. Next is V77. (V71 nets, V72 container access-state, V73/V74 vocab, V75 container progression, V76 carrying aids.) |
...
## What Is Built (Migrations V1–V76, all applied)
...
> Full suite **158 backend tests + 11 SQL regressions green** on the V1–V76 chain; each commit compiles with tests
...
> - **EPIC #54 supply chains — IN PROGRESS.** **#56 containers + #57 carrying aids ADVANCED (V75-V76):** fixed a latent bug —
