...
public class ChronicleActionController {
    ...
    @PostMapping @ResponseStatus(HttpStatus.CREATED) public ChronicleActionService.ActionResult resolve(@RequestBody ActionRequest request) { return actions.resolvePlan(request.text(), request.idempotencyKey()); }
