...
public class ChronicleActionService {
    ...
    private int durationFor(String action, Intent intent) {
        ...
        return switch (intent) { case OBSERVE -> 10; case REST -> 60; case GATHER_FIBER, GATHER_STONE, GATHER_BERRIES, GATHER_BRANCHES -> 25; case EAT, DRINK, LIGHT_FIRE -> 5; case TREAT_WOUND, CONFRONT_WILDLIFE -> 10; case CRAFT_BASKET -> 45; case BUILD_FIRE_PIT, START_LEAN_TO -> 30; case WORK_LEAN_TO -> 45; case MOVE -> 30; default -> 5; };
    }
    ...
    private record ActiveChronicle(UUID id, UUID location) { } private enum Intent { OBSERVE, MOVE, REST, GATHER_FIBER, GATHER_STONE, GATHER_BERRIES, GATHER_BRANCHES, EAT, DRINK, WASH, TREAT_WOUND, LIGHT_FIRE, CONFRONT_WILDLIFE, CRAFT_BASKET, BUILD_FIRE_PIT, START_LEAN_TO, WORK_LEAN_TO, URINATE, DEFECATE, UNKNOWN }
