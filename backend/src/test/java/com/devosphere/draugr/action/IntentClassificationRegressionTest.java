...
class IntentClassificationRegressionTest {
    ...
    private String classify(String text, boolean processMatches) throws Exception {
        ...
        ChronicleActionService svc = new ChronicleActionService(null, null, null, null, items, null, null, null, null, null, null, null, new com.devosphere.draugr.narration.ActionInputClassifier(), null, null, null, new com.devosphere.draugr.narration.NarrationEngine());
