...
/** Story #96 slice 7 - feet; boots via 'moccasin', snowshoes via 'lace', made per side. */
@SpringBootTest
class LeatherEquipFeetIntegrationTest {
    ...
    void footwearIsMadePerSide() {
        ...
        // A boot made via 'moccasin' (routes around CRAFT_GARMENT's 'boot'/'shoe').
        var left = actions.resolve("make a left leather moccasin");
        ...
        assertEquals(14, (int) jdbc.queryForObject(
            ...
            "('hide_boot_left','hide_boot_right','leather_boot_left','leather_boot_right','fur_boot_left','fur_boot_right','leather_gaiter_left','leather_gaiter_right'," +
            "'hide_sock_left','hide_sock_right','fur_sock_left','fur_sock_right','snowshoe_left','snowshoe_right')", Integer.class));
