...
/** Story #96 slice 2 - leather/rawhide/fur torso wear and body armour. */
@SpringBootTest
class LeatherEquipTorsoIntegrationTest {
    ...
    @Test
    void leatherTorsoWearIsSewnAndEquippable() {
        ...
        var made = actions.resolve("make a leather vest");
        assertEquals("SUCCEEDED", made.outcome(), () -> "sewing a leather vest must succeed: " + made.perception());
        assertTrue(items.hasAtLeast(chronicle, "leather_vest", 1), "a leather vest must now be in hand");
        ...
        assertEquals(7, (int) jdbc.queryForObject(
            ...
            "('rawhide_vest','leather_vest','fur_vest','leather_tunic','hide_tunic','leather_cuirass','rawhide_chest_panel')", Integer.class));
