...
/** Story #95 slice 6 - sleep and hygiene gear. "make a bark comb" routes past the existing bone-comb recipe. */
@SpringBootTest
class SurvivalEquipSleepHygieneIntegrationTest {
    ...
    @Test
    void sleepAndHygieneGearIsMadeAndEquippable() {
        ...
        items.createCarriedItem(chronicle, "bark_sheet", "Bark sheet", now, "TEST_FIXTURE");
        var made = actions.resolve("make a bark comb");
