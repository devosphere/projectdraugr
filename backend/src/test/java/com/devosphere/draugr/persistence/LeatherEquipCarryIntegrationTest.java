...
/** Story #96 slice 3 - leather carry gear (backpacks, quivers, tool roll, bottle carrier). */
@SpringBootTest
class LeatherEquipCarryIntegrationTest {
    ...
    @Test
    void leatherCarryGearIsSewnAndEquippable() {
        ...
        var made = actions.resolve("make a leather backpack");
        assertEquals("SUCCEEDED", made.outcome(), () -> "sewing a leather backpack must succeed: " + made.perception());
        assertTrue(items.hasAtLeast(chronicle, "leather_backpack", 1), "a leather backpack must now be in hand");
        ...
        assertEquals(6, (int) jdbc.queryForObject(
            ...
            "('leather_backpack','hide_backpack','leather_quiver','hide_quiver','leather_tool_roll','leather_water_bottle_sling')", Integer.class));
